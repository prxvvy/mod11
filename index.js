...
var limpiarRut = function (rut) {
    ...
    if (typeof rut !== 'string')
        throw new TypeError('limpiarRut() espera un parametro de tipo string.');
...
var obtenerDigitoVerificador = function (rut) {
    ...
    if (typeof rut !== 'string')
        throw new TypeError('obtenerDigitoVerificador() espera un parametro de tipo string.');
...
var darFormato = function (rut, puntos) {
    ...
    if (typeof rut !== 'string')
        throw new TypeError('darFormato() espera un parametro de tipo string.');
    if (!puntos)
        return addon.darFormato(rut, false);
    if (puntos && typeof puntos !== 'boolean')
        throw new TypeError('Si se va a dar formato al rut con puntosm, el Segundo parametro debe ser de tipo booleano.');
...
var validarRut = function (rut) {
    ...
    if (typeof rut !== 'string')
        throw new TypeError('validarRut() espera un parametro de tipo string.');
